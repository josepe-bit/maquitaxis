-- Migration: 20260910000000_add_last_change_info_to_alerts_rpc.sql
-- Description: Expose last_change_mileage and last_change_date from public.control in public.get_vehicle_event_alerts() RPC for Dashboard overview.
